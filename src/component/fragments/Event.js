...
export default function Event() {
  const calculateTime = () => {
    let dueDate = new Date(
      "2022-03-20 09:00:00 GMT+07:00 (Western Indonesian Time)"
    );
    const d = new Date();
          ...
          <Fade top delay={300}>
            <div className="mt-4 mb-8 flex justify-center">
              <a
                ...
                href="https://goo.gl/maps/d1kiGxyzcVzp6QSEA"
                target="_blank"
                rel="noreferrer"
              >
                map lokasi
